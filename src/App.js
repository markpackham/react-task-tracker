...
function App() {
  ...
  // Update Task (used for reminder updates)
  ...
  const toggleReminder = async (id) => {
    const taskToToggle = await updateTasks(id);
  ...
  // && is a shorthand way of doing a terniary so we hide AddTask form till it is needed
